...
<head>
    ...
    <title>Developer | Periodic-Table</title>
...
<body onload="loaingFunction()">
    <div id="loading"><p><i class="fab fa-dev"></i></p></div>
    <div id="page">
        <!-- navbar -->
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right mt-2" aria-labelledby="dropdownLanguage">
                            <a class="dropdown-item" href="./php/change.php?lang=en&path=developer"><span class="flag-icon flag-icon-us mr-2"></span>English<i
                                    class="fas fa-check text-success ml-1"></i>
                            </a>
                            <a class="dropdown-item" href="./php/change.php?lang=th&path=developer"><span class="flag-icon flag-icon-th mr-2"></span>Thai</a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="container">
            ...
            <hr>
            <div id="memberList" class="row justify-content-center"></div>
            <a class="btn_change" href="./php/darkmode.php?path=developer"><?php if($_COOKIE['darkstatus']) echo "<i class='fas fa-lightbulb'></i>"; else echo "<i class='fas fa-moon'></i>";?></a>
            <!-- footer -->
            <hr>
    ...
    <script src="./js/myScript/developer.js"></script>
